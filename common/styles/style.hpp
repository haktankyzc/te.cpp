...
private:
  ...
  // Editor ekraninda metin ekranin soldan ve sagdan 4. indexinden basliyor

  // INFO: ENTRY_WIN CONSTANTS
  const int m_required_term_rows = 30;
  const int m_required_term_cols = 80;

  // INFO: App logo and dimensions
